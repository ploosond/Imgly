        ...
        {user ? (
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              ...
              <p className="text-xl sm:text-sm font-medium text-gray-600">
                Credits left : 50
              </p>
            </button>
            <p className="text-gray-600 max-sm:hidden pl-4">Hi, Prajwol</p>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            <p onClick={() => naviagte("/buy")} className="cursor-pointer">
              Pricing
            </p>
